...
namespace NovelGame
{
    public class UserScriptManager : MonoBehaviour
    {
        ...
        public void ExecuteStatement(string sentence)
        {
            ...
            {
                case "&center":
                    GameManager.Instance.imageManager.PutImage(words[1], words[2], 960, 540);
                    break;
                case "&left":
                    GameManager.Instance.imageManager.PutImage(words[1], words[2], 540, 540);
                    break;
                case "&right":
                    GameManager.Instance.imageManager.PutImage(words[1], words[2], 1380, 540);
                    break;
                case "&rmimg":
